...
class RAGService:
    """Vector search service for prescription data using embeddings."""
    ...
    def __init__(self, db_connection=None) -> None:
        ...
        Args:
            db_connection: MongoDB connection. If None, will be imported from the host project.
        """
        ...
        self.collection = self.db["prescription_vectors"] if self.db else None
    ...
    async def index_prescription(
        ...
        """
        Construct chunk text, generate vector embedding, and store in MongoDB.
        ...
        try:
            ...
            if not self.collection:
                raise RuntimeError("Database connection not initialized for RAG service")
    ...
    async def search_prescriptions(
        ...
        """
        Search prescription vectors scoped to patient_id.
        Applies similarity_threshold filtering and top_k limit.
        """
        try:
