...
from chatbot.common.auth_helpers import verify_token, require_role
...
class ChatbotController:
    ...
    def __init__(self, appointment_controller) -> None:
    ...
    async def _execute_tool(self, tool_name: str, args: dict, authorization: str) -> dict:
        """Dispatcher for tool calls to appointment controller and RAG service."""
        try:
